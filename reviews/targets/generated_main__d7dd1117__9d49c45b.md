...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "d7dd1117d42b6240e1869e9ebdcf7e6de931f0c6c08e64a7ca98af7bc2961bf1",
    "sha8": "d7dd1117",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "9d49c45b9fe66dc534f89c42ea1f13ec4c4e75bae61d28749f45ccad71b85a68",
    "sha8": "9d49c45b"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_d7dd1117_9d49c45b"
}
```
...
Mean contact pattern visualizations summarize par-
ticipant specific spatial structure and cross participant
shifts derived from the audited raw exports.
...
Figure 2: Channel mean heatmap for participant one
dataset.
...
=== PAGE 3 ===
Figure 3: Channel mean difference heatmap between
participant three and participant one datasets.
4 Models
...
against simple similarity measures, and the scatter
plot summarizes the conditional pattern across au-
dited source pairs and targets.
...
=== PAGE 6 ===
Figure 4: Multi source transfer delta versus similarity
