...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "0827b14f38c1b34228e3fd98e734e04a4d8b88a4ecb8b912e5a59e890335d3b1",
    "sha8": "0827b14f",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "bd3c9c7887e823491ab9fa352970427fd565e3e356bb5c598dd1de7a9f0b8115",
    "sha8": "bd3c9c78"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_0827b14f_bd3c9c78"
}
```
...
in P2, but rises to 0.691+/-0.133 in P3, identifying
cross-participant transfer as the dominant bottleneck.
At full channels, rowcol tracks vec more closely than
grid variants in most settings. For the p4 target aggre-
gate, paired-source transfer lowers CER from 0.686+/-
0.114 to 0.582+/-0.064 and LEX from 0.659+/-0.073
to 0.554+/-0.034, while direction-level gains remain
mixed. These findings provide a reproducible baseline
within our audited datasets and protocol definitions.
1 Introduction
