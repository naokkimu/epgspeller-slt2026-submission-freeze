...
```json
{
  ...
  "paper_json_sha256": "1d89e86db6a0a4abc090456c4f899a2243c180e8cda42a67bf001676d04f9854",
  "policy": {
...
[
  ...
  },
  {
    ...
    "sha256": "1e9c4aa1eae55b7eb9bb3101c9650b315307749991ec311ef60e129627fbb3e8"
  },
  {
    "bytes": 469,
    ...
    "sha256": "b624ed713b6fc69f4e5324c730be3f92f69eef0ec7601d0c9aba1376930e5630"
  },
  {
    "bytes": 226,
    ...
    "sha256": "af5e2fc5a9e62a33afefdf28a4bd8b71d5b07f39a45eca0287276fa9c08e9399"
  },
  {
    "bytes": 499,
    ...
    "sha256": "8f6cb11b30de05978a8c938e542ba27b1d856f288d2d8fbd123cf8e21cf90a1c"
  },
  {
    "bytes": 749,
    ...
    "sha256": "daeaae28ed5a984eaf231b1163b19f8eeb006a0367471fabe6507dc0a78745fb"
  },
  {
    "bytes": 441,
    ...
    "sha256": "17c076db2e58f4a4ef98a2d5b9dfa95b1a7b8960e4f163bb2c7e1d53c41206ee"
  },
  {
    "bytes": 441,
    ...
    "sha256": "796eebf5af3193a3619284185ee914e8b9ceb33cf8bfc73f4ff55c0c7691c56f"
  },
  {
    "bytes": 441,
    ...
    "sha256": "a07aed69f845139aabdebeb0d240880e9c42d99b97312429e4115641d58e6dda"
  },
  {
    "bytes": 711,
    ...
    "sha256": "6c69487cc206ae246616b66b335deba6d0481153900219282ca3064d1e5818fd"
  },
  {
    "bytes": 296,
  ...
  },
  {
    ...
    "sha256": "7576a00a7cc009e8c3c0227662a61fb902f39ce364ce8de4bdaec10d7fd399d9"
  },
  {
    "bytes": 20650,
...
Text:
```text
The dataset summary table reports raw sample counts, vocabulary sizes, median sequence length, total frames, mean contact rate, and excluded all-zero counts for each participant dataset.
```
...
Text:
```text
The spatial modeling tables compare spatial inductive bias variants at full channels across protocols, including a patchpool grid encoder as a minimal implementation rescue. The row and column front end tracks the vector baseline more closely than the convolutional grid front end under within participant protocols, while patchpool reduces the gap under cross participant transfer. Across protocols, grid variants tend to increase real time factor relative to the vector baseline.
```
...
Text:
```text
We evaluate multi source cross participant transfer using paired source participants. The multi source table reports direction level results for vector and layout aware front ends.
```
...
Text:
```text
We evaluate low shot adaptation for a new participant by varying the number of training instances per word. The k shot table summarizes results for vector and layout aware front ends.
```
...
- status: supported
- evidence_ids: ev_msx20260224_split_npz_manifest_csv, ev_msx20260224_metrics_csv, ev_msx20260224_table_main_csv, ev_paper_layout_2026_03_03_table_spatial_p1_csv, ev_paper_layout_2026_03_03_table_spatial_p2_csv, ev_paper_layout_2026_03_03_table_spatial_p3_csv, ev_paper_layout_2026_03_03_table_k64_p1p2_csv, ev_paper_layout_2026_03_03_table_k64_p3_csv, ev_uc20260226_split_npz_manifest_to4_csv, ev_paper_layout_2026_03_03_table_to4_compact_csv, ev_uc20260226_p3ms_conditions_csv
...
- status: supported
- evidence_ids: ev_msx20260224_table_main_csv, ev_config_outline_yaml
...
[
  {
    ...
    "left": {
      "evidence_id": "ev_msx20260224_table_main_csv",
      "group": 1,
      "kind": "regex",
      "pattern": "(protocol,variant)"
    },
    "left_value": "protocol,variant",
    "ok": true,
    "op": "==",
    "right": "protocol,variant",
    "right_value": "protocol,variant"
  }
]
```
