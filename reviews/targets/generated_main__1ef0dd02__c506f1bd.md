...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "1ef0dd02b3d6bc61f60725331debaab289b7086818fe4368b7a9837ce83c480f",
    "sha8": "1ef0dd02",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "c506f1bd80065b33d2d968c895cb57273d5f3d1e7f839823a2c63477b7651401",
    "sha8": "c506f1bd"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_1ef0dd02_c506f1bd"
}
```
...
and splits used in this study are derived from partici-
pant recordings, and we focus on methodological clar-
ity and artifact traceability rather than deployment
claims. We used generative AI tools for language
polishing and formatting support, and we verified
technical claims against audited artifacts.
9 Logic Checks
The baseline table includes protocol and aggregate
metrics fields.
The dataset summary table includes id, N, V, Tmed,
contact, and zero fields.
The spatial modeling table includes protocol, vari-
ant, CER, and RTF fields.
The electrode reduction table includes protocol,
method, CER, and RTF fields.
References
...
review,” 2021.
[5] X. Dong, Y. Chen, Y. Nishiyama, K. Sezaki,
...
fication,” 2006.
[7] N. Kimura, T. Gemicioglu, J. Womack, R. Li,
