...
```json
{
  ...
  "paper_json_sha256": "e989916359db0574e4699a8e91f107f0c629b6637b0a037b3cc73c6185d9f557",
  "policy": {
...
[
  ...
  },
  {
    ...
    "sha256": "c5705035528bb3eec658390dc185746d0ba2bd3c4ae43149d37518a70c538602"
  },
  {
    "bytes": 10496,
...
Text:
```text
We report results only for audited artifacts and do not claim broader demographic coverage. The datasets and splits used in this study are derived from participant recordings, and we focus on methodological clarity and artifact traceability rather than deployment claims. We used generative AI tools for language polishing and formatting support, and we verified technical claims against audited artifacts.
```
...
#### Block cl_dataset_summary_has_header (kind=paragraph)
- status: supported
- evidence_ids: ev_paper_layout_2026_03_03_table_dataset_summary_csv
...
[
  {
    "cast_spec": null,
    "cast_used": "string",
    "id": "a_dataset_summary_header",
    "left": {
      "evidence_id": "ev_paper_layout_2026_03_03_table_dataset_summary_csv",
      "group": 1,
      "kind": "regex",
      "pattern": "(id,N,V,Tmed,contact,zero)"
    },
    "left_value": "id,N,V,Tmed,contact,zero",
    "ok": true,
    "op": "==",
    "right": "id,N,V,Tmed,contact,zero",
    "right_value": "id,N,V,Tmed,contact,zero"
  }
]
```

#### Block cl_spatial_table_has_header (kind=paragraph)
- status: supported
- evidence_ids: ev_paper_layout_2026_03_03_table_spatial_all_csv
...
[
  {
    "cast_spec": null,
    "cast_used": "string",
    "id": "a_spatial_table_header",
    "left": {
      "evidence_id": "ev_paper_layout_2026_03_03_table_spatial_all_csv",
      "group": 1,
      "kind": "regex",
      "pattern": "(protocol,variant,cer,rtf)"
    },
    "left_value": "protocol,variant,cer,rtf",
    "ok": true,
    "op": "==",
    "right": "protocol,variant,cer,rtf",
    "right_value": "protocol,variant,cer,rtf"
  }
]
```

#### Block cl_k64_table_has_header (kind=paragraph)
- status: supported
- evidence_ids: ev_paper_layout_2026_03_03_table_k64_all_csv
...
[
  {
    "cast_spec": null,
    "cast_used": "string",
    "id": "a_k64_table_header",
    "left": {
      "evidence_id": "ev_paper_layout_2026_03_03_table_k64_all_csv",
      "group": 1,
      "kind": "regex",
      "pattern": "(protocol,method,cer,rtf)"
    },
    "left_value": "protocol,method,cer,rtf",
    "ok": true,
    "op": "==",
    "right": "protocol,method,cer,rtf",
    "right_value": "protocol,method,cer,rtf"
  }
]
```
