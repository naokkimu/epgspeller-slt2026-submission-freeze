...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "5771fc0be0e892a0223f4509bc2ccc64a7578b1104c2b477a1dc2cc3a8798629",
    "sha8": "5771fc0b",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "01db91d4ac4d099fe196f177f9b1dcefc66fef6b45f8f4ff51d072499cb575b9",
    "sha8": "01db91d4"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_5771fc0b_01db91d4"
}
```
...
We visualize the positioning of prior work using
survey tags that map systems by representation and
system scope, providing an overview of where open
vocabulary silent spelling and electropalatography
studies sit in the space.
1

=== PAGE 2 ===
Figure 1: Positioning of prior work by representation
and system scope.
...
=== PAGE 3 ===
Table 2: Baseline recap across three evaluation proto-
...
protocols.
protocol variant cer lex rtf
P1 vec 0.18±0.08 0.10±0.07 0.0006±0.0002
P1 rowcol 0.20±0.09 0.13±0.08 0.0024±0.0011
P1 grid 0.31±0.15 0.25±0.18 0.0036±0.0015
P1 grid aug 0.31±0.14 0.26±0.17 0.0034±0.0011
P1 patch 0.30±0.07 0.24±0.07 0.0038±0.0017
P1 patch aug 0.30±0.09 0.23±0.09 0.0039±0.0017
P2 vec 0.15±0.06 0.07±0.05 0.0001±0.0000
P2 rowcol 0.16±0.08 0.09±0.06 0.0002±0.0000
P2 grid 0.29±0.21 0.23±0.25 0.0004±0.0000
P2 grid aug 0.31±0.24 0.26±0.29 0.0004±0.0000
P2 patch 0.34±0.23 0.28±0.27 0.0007±0.0001
P2 patch aug 0.30±0.16 0.24±0.19 0.0006±0.0000
P3 vec 0.69±0.13 0.64±0.06 0.0001±0.0000
P3 rowcol 0.68±0.15 0.63±0.09 0.0002±0.0000
P3 grid 0.75±0.09 0.74±0.07 0.0004±0.0000
P3 grid aug 0.76±0.09 0.75±0.08 0.0004±0.0000
P3 patch 0.69±0.11 0.68±0.08 0.0006±0.0001
P3 patch aug 0.70±0.13 0.67±0.11 0.0005±0.0001
any protocol.
