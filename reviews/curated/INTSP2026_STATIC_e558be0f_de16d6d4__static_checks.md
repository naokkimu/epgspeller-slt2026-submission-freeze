...
- pdf: paper/submission/interspeech2026_review.pdf (sha8=e558be0f, pages=5, extracted_chars=22122, truncated=False)
- tex: paper/submission/interspeech2026_review.tex (sha8=de16d6d4)
...
| `abstract_length` | info | yes | abstract_chars=892 <= max_characters=1000 |
