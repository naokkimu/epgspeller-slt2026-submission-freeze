...
- pdf: paper/manuscript/generated_main.pdf (sha8=adaede7c, pages=4, extracted_chars=22992, truncated=False)
- tex: paper/manuscript/generated_main.tex (sha8=72cddefa)
