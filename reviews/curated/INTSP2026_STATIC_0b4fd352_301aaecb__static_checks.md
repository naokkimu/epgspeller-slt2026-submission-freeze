...
- pdf: paper/submission/interspeech2026_review.pdf (sha8=0b4fd352, pages=4, extracted_chars=23591, truncated=False)
- tex: paper/submission/interspeech2026_review.tex (sha8=301aaecb)
...
| `abstract_length` | info | yes | abstract_chars=880 <= max_characters=1000 |
...
| `page_limit` | info | yes | page_count=4 <= max_pages=6 |
