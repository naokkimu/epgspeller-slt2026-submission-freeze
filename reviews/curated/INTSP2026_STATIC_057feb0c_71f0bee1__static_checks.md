...
- paper_type: regular
- ai_tools_used: true
- pdf: paper/submission/interspeech2026_review.pdf (sha8=057feb0c, pages=5, extracted_chars=24528, truncated=False)
- tex: paper/submission/interspeech2026_review.tex (sha8=71f0bee1)
...
| `abstract_length` | info | yes | abstract_chars=990 <= max_characters=1000 |
| `abstract_no_citations` | info | yes | no \cite* in abstract |
| `ai_disclosure_required` | warn | no | ai_tools_used=true but disclosure section not found |
...
- (warn) `ai_disclosure_required`: ai_tools_used=true but disclosure section not found
