...
- pdf: paper/manuscript/generated_main.pdf (sha8=ec0d2bd6, pages=7, extracted_chars=21451, truncated=False)
- tex: paper/manuscript/generated_main.tex (sha8=75141a75)
...
| `abstract_length` | info | yes | abstract_chars=821 <= max_characters=1000 |
