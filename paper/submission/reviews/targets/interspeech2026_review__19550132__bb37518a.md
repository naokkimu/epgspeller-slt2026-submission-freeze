...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "195501324b156abe9232fea15d97ce9aa75079d074905e1a75c6dbaabb599ee0",
    "sha8": "19550132",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "bb37518ad9941df73459b3d4f58f25731ea48956f4444ec12f3d1d6e536fda72",
    "sha8": "bb37518a"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_19550132_bb37518a"
}
```
...
manifest artifact. Group labels use sX-Y for single source and105
sXY-Y for paired sources. In our audited splits, the multi source106
aggregation reduces CER relative to the single source aggrega-107
tion for the same target.108
The spatial modeling tables compare spatial inductive bias109
variants at full channels across protocols, including a patchpool110
grid encoder as a minimal implementation rescue. The vari-111
ant labels are vec, rowcol, grid, grid aug, patch, and patch aug.112
The row and column front end tracks the vector baseline more113
...
closely than the convolutional grid front end under within par-114
ticipant protocols, while patchpool reduces the gap under cross115
participant transfer. Across protocols, grid variants tend to in-116
crease real time factor relative to the vector baseline, and we do117
not observe a consistent accuracy gain over the vector baseline118
in any protocol. 119
The electrode reduction tables evaluate a reduced channel120
budget using several selection strategies. The method labels121
are topk, fps two k, xfer, and rand. Across protocols, within122
participant selection and simple transfer selection yield similar123
performance, suggesting that a compact subset can preserve a124
large fraction of the vector baseline performance. Random se-125
lection and simple transfer remain slightly worse than within126
participant selection in the audited results.127
We evaluate multi source cross participant transfer using128
paired source participants. The group labels indicate the two129
source participants followed by the target participant. The multi130
source table reports direction level results for vector and layout131
aware front ends. 132
We evaluate low shot adaptation for a new participant by133
varying the number of training instances per word. The k shot134
table summarizes one shot and two shot results for vector and135
layout aware front ends.136
6. Discussion137
Our results suggest that an explicit convolutional grid encoder138
is not automatically beneficial for electropalatography under139
within participant evaluation, despite its intuitive spatial struc-140
ture. A patchpool grid variant reduces the underperformance of141
the grid encoder under cross participant transfer, indicating that142
spatial encoder design choices can materially affect outcomes,143
but it does not yield consistent gains over the vector baseline144
across protocols. Spatial augmentation can improve robustness145
to synthetic electrode dropout, but it does not close the accuracy146
gap for the convolutional grid variants in our multi participant147
results. Additional analyses on multi source cross participant148
transfer and low shot adaptation are provided as artifact tables,149
...
and they highlight that cross participant performance remains150
challenging. We also provide a conditions analysis of multi151
source transfer deltas versus simple dataset similarity measures,152
which shows that the effect is conditional and does not present153
a single dominant monotonic trend within our evaluated group154
set. These observations are limited to our audited multi partici-155
pant dataset collection and protocols.156
7. Artifacts and Auditability157
This repository uses a strict paper registry that pins every ev-158
idence file by checksum and rejects unsupported manuscript159
blocks. The split manifests, aggregated metrics, compact tables,160
and analysis summaries referenced in this paper are stored as161
deterministic artifacts, enabling audit and reproduction within162
our repository environment.163
8. Ethics and Disclosure164
We report results only for audited artifacts and do not claim165
broader demographic coverage. The datasets and splits used in166
this study are derived from participant recordings, and we focus167
on methodological clarity and artifact traceability rather than168
deployment claims.169
9. Logic Checks170
The baseline table includes protocol and variant fields.171
10. References172
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert,173
and J. Brumberg, “Silent speech interfaces,” 2010. [On-174
line]. Available: https://sciencedirect.com/science/article/pii/175
S0167639309001307176
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction177
to Silent Speech Interfaces, 2017. [Online]. Available: https:178
//link.springer.com/book/10.1007/978-3-319-40174-4179
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,180
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces181
for speech restoration: A review,” 2020. [Online]. Available:182
https://ieeexplore.ieee.org/document/9205294/183
...
[4] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov,184
and S. Lee, “Biosignal sensors and deep learning-based185
speech recognition: A review,” 2021. [Online]. Available:186
https://doi.org/10.3390/s21041399187
[5] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang,188
K. Christofferson, and A. Mariakakis, “Rehearsse: Recognizing189
hidden-in-the-ear silently spelled expressions,” 2024. [Online].190
Available: https://dl.acm.org/doi/10.1145/3613904.3642095191
[6] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-192
nectionist temporal classification,” 2006. [Online]. Available:193
https://dl.acm.org/doi/10.1145/1143844.1143891194
[7] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao,195
A. Bedri, Z. Su, A. Olwal, J. Rekimoto, and T. Starner,196
“Silentspeller: Towards mobile, hands-free, silent speech text197
entry using electropalatography,” 2022. [Online]. Available:198
https://dl.acm.org/doi/10.1145/3491102.3502015199
[8] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality200
reduction of electropalatographic data using latent variable201
models,” 1998. [Online]. Available: https://sciencedirect.com/202
science/article/pii/S0167639398000594203
[9] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and204
G. Calder, “New developments in electropalatography: A205
state-of-the-art report,” 1989. [Online]. Available: https:206
//doi.org/10.3109/02699208908985268207
[10] W. J. Hardcastle, “Electropalatography in phonetic research208
and in speech training,” 1990. [Online]. Available: https:209
//isca-archive.org/icslp 1990/hardcastle90b icslp.html210
[11] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data211
reduction methods and their implications for studies of lingual212
coarticulation,” 1991. [Online]. Available: https://doi.org/10.213
1016/S0095-4470(19)30343-2214
[12] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus,215
and M. Stone, “Development of a silent speech interface driven216
by ultrasound and optical images of the tongue and lips,” 2010.217
[Online]. Available: https://sciencedirect.com/science/article/pii/218
S0167639309001733219
[13] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth220
measurement of face and palate by structured light,” 1993.221
[Online]. Available: https://isca-archive.org/eurospeech 1993/222
shadle93 eurospeech.html223
[14] A. Toutios and K. Margaritis, “Learning electropalatograms from224
acoustics.” [Online]. Available: https://doi.org/10.1109/ICASSP.225
2006.1660032 226
...
[15] ——, “On the acoustic-to-electropalatographic mapping,” 2006.227
[Online]. Available: https://link.springer.com/chapter/10.1007/228
11613107 16229
[16] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-230
Aldasoro, “Visualisation and analysis of speech production231
with electropalatography,” 2019. [Online]. Available: https:232
//doi.org/10.3390/jimaging5030040233
[17] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design234
and evaluation of korean electropalatography (k-epg),” 2021.235
[Online]. Available: https://doi.org/10.3390/s21113802236
[18] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph,237
E. D. Cubuk, and Q. V . Le, “Specaugment: A simple data238
augmentation method for automatic speech recognition,” 2019.239
[Online]. Available: https://isca-archive.org/interspeech 2019/240
park19 interspeech.html241
