...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "b7e6b538f990b0fc9b2ac915bf25205ec4656654ed33546bc6ee86c065307e44",
    "sha8": "b7e6b538",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "9cbd2c11de006b199d1565d990933532b84d376971d74612fe913d8ccdd5eedc",
    "sha8": "9cbd2c11"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_b7e6b538_9cbd2c11"
}
```
...
Within-participant selection is similar to the vector base-173
line, while transfer and random subsets are generally lower and174
mixed across protocols.175
We visualize how error and streaming speed change as the176
electrode budget varies.177
...
Error generally increases as the electrode budget shrinks,178
and streaming cost increases as channels are removed; the179
slopes vary by selection strategy.180
We evaluate paired-source cross-participant transfer under181
the same target and protocol constraints.182
Paired-source transfer is mixed across targets and front183
ends.184
We evaluate low-shot adaptation by varying the number of185
training instances per word for a new participant.186
Two-shot generally improves over one-shot, while layout-187
aware variants remain mixed relative to the vector baseline.188
5. Discussion189
Across protocols, layout-aware front ends do not consistently190
outperform the vector baseline and often increase streaming191
cost; the patchpool grid reduces but does not eliminate the gap.192
Cross-participant transfer remains the main bottleneck. Source193
aggregation and low-shot adaptation help in some settings, but194
outcomes are mixed, and simple similarity indicators do not195
yield a single rule for when multi-source helps. Design implica-196
tion: when low latency is the priority, the vector or row/col front197
ends are safer choices; when robustness to electrode dropout198
or spatial priors is desired, grid-based options require careful199
tuning and validation. These takeaways depend on the audited200
datasets, split protocols, and evaluation pipeline, and they may201
not transfer to other sensors, labeling schemes, or participant202
populations.203
6. Artifacts and Auditability204
This repository uses a strict paper registry that pins every ev-205
idence file by checksum and rejects unsupported manuscript206
blocks. The split manifests, aggregated metrics, compact ta-207
bles, statistical summaries, and analysis reports referenced in208
...
this paper are stored as deterministic artifacts, enabling audit209
and reproduction within our repository environment. A supple-210
mentary archive includes the compact statistical summary table211
for reviewers. 212
7. Ethics and Disclosure213
We report results only for audited artifacts and do not claim214
broader demographic coverage. The datasets and splits used in215
this study are derived from participant recordings, and we focus216
on methodological clarity and artifact traceability rather than217
deployment claims. 218
8. Generative AI Use Disclosure219
We used generative AI tools for language polishing and format-220
ting support, and we verified technical claims against audited221
artifacts. 222

=== PAGE 4 ===
Figure 1:Error and streaming speed versus electrode budget in
an audited run set.
...
=== PAGE 5 ===
9. References223
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and224
J. Brumberg, “Silent speech interfaces,” 2010.225
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction226
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and227
Computer Engineering. Springer, 2017.228
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,229
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces230
for speech restoration: A review,” 2020.231
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,232
“New developments in electropalatography: A state-of-the-art re-233
port,” 1989.234
[5] W. J. Hardcastle, “Electropalatography in phonetic research and235
in speech training,” 1990.236
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and237
S. Lee, “Biosignal sensors and deep learning-based speech recog-238
nition: A review,” 2021.239
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,240
“Visualisation and analysis of speech production with elec-241
tropalatography,” 2019.242
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and243
evaluation of korean electropalatography (k-epg),” 2021.244
[9] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-245
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-246
the-ear silently spelled expressions,” 2024.247
[10] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,248
and P. Green, “Isolated word recognition of silent speech249
using magnetic implants and sensors,” 2010. [Online]. Available:250
https://pubmed.ncbi.nlm.nih.gov/20863739/251
[11] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-252
nectionist temporal classification,” 2006.253
[12] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and254
M. Stone, “Development of a silent speech interface driven by255
ultrasound and optical images of the tongue and lips,” 2010.256
[13] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,257
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-258
wards mobile, hands-free, silent speech text entry using elec-259
tropalatography,” 2022.260
[14] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-261
tion of electropalatographic data using latent variable models,”262
1998.263
[15] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction264
methods and their implications for studies of lingual coarticula-265
tion,” 1991.266
[16] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth mea-267
surement of face and palate by structured light,” 1993.268
[17] A. Toutios and K. Margaritis, “Learning electropalatograms from269
acoustics,” 2006.270
[18] ——, “On the acoustic-to-electropalatographic mapping,” 2006.271
[19] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph, E. D. Cubuk,272
and Q. V . Le, “Specaugment: A simple data augmentation method273
for automatic speech recognition,” 2019.274
