...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "4fadd540c18019e56469dfe6f020c4f7c16abe523cfe4bdd2a0e5d23a689b36a",
    "sha8": "4fadd540",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "bef4f2dcaba86cff9b4dd013bf98e725bb2eba883184a51be88d271fb12f3b10",
    "sha8": "bef4f2dc"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_4fadd540_bef4f2dc"
}
```
...
ends.174
We evaluate cross-participant transfer with the fourth par-175
ticipant as target under single-source and paired-source settings.176
Paired-source transfer is often lower error than single-177
source transfer, but direction-level outcomes are mixed.178
