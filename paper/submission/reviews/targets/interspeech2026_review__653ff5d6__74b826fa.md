...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "653ff5d66813112f961e4331b548d858924130bfa6d51a02db7f44281b7304f2",
    "sha8": "653ff5d6",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "74b826faccfb1f820313f7fff5497894648690f29c8384c83edb79b48e8b8dce",
    "sha8": "74b826fa"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_653ff5d6_74b826fa"
}
```
...
=== PAGE 5 ===
5. Discussion198
Across protocols, layout-aware front ends do not consistently199
outperform the vector baseline and often increase streaming200
cost; the patchpool grid reduces but does not eliminate the gap.201
Cross-participant transfer remains the main bottleneck. Source202
aggregation and low-shot adaptation help in some settings, but203
outcomes are mixed, and simple similarity indicators do not204
yield a single rule for when multi-source helps. Design implica-205
tion: when low latency is the priority, the vector or row/col front206
ends are safer choices; when robustness to electrode dropout207
or spatial priors is desired, grid-based options require careful208
tuning and validation. These takeaways depend on the audited209
datasets, split protocols, and evaluation pipeline, and they may210
not transfer to other sensors, labeling schemes, or participant211
populations.212
...
8. Generative AI Use Disclosure228
We used generative AI tools for language polishing and format-229
ting support, and we verified technical claims against audited230
artifacts.231
9. References232
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and233
J. Brumberg, “Silent speech interfaces,” 2010.234
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction235
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and236
Computer Engineering. Springer, 2017.237
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,238
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces239
for speech restoration: A review,” 2020.240
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,241
“New developments in electropalatography: A state-of-the-art re-242
port,” 1989.243
[5] W. J. Hardcastle, “Electropalatography in phonetic research and244
in speech training,” 1990.245
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and246
S. Lee, “Biosignal sensors and deep learning-based speech recog-247
nition: A review,” 2021.248
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,249
“Visualisation and analysis of speech production with elec-250
tropalatography,” 2019.251
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and252
evaluation of korean electropalatography (k-epg),” 2021.253
[9] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-254
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-255
the-ear silently spelled expressions,” 2024.256
[10] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,257
and P. Green, “Isolated word recognition of silent speech258
using magnetic implants and sensors,” 2010. [Online]. Available:259
https://pubmed.ncbi.nlm.nih.gov/20863739/260
[11] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-261
nectionist temporal classification,” 2006.262
[12] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and263
M. Stone, “Development of a silent speech interface driven by264
ultrasound and optical images of the tongue and lips,” 2010.265
[13] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,266
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-267
wards mobile, hands-free, silent speech text entry using elec-268
tropalatography,” 2022.269
[14] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-270
tion of electropalatographic data using latent variable models,”271
1998. 272
[15] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction273
methods and their implications for studies of lingual coarticula-274
tion,” 1991. 275
