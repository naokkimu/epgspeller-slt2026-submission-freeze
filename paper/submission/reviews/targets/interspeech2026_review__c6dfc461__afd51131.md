...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "c6dfc461d28993dd2fa701ecdf0735553941576fb9032654852f3004a8b147f2",
    "sha8": "c6dfc461",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "afd5113173b236ee608e136ef734d8770aa0f2c26dcc534a14bf5db4a49b841a",
    "sha8": "afd51131"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_c6dfc461_afd51131"
}
```
...
Table 7 evaluates paired-source cross-participant transfer220
under the same target and protocol constraints.221
...
Table 7 is target dependent: for p23-¿p1, vec 0.473 and222
rowcol 0.476 outperform grid 0.602 and grid aug 0.691, while223
for p12-¿p3, grid 0.736 outperforms vec 0.838 and rowcol224
0.790. Multi-source benefit is therefore conditional rather than225
universal.226
Table 7 also contains an intermediate regime where meth-227
ods are close: for p13-¿p2, CER is 0.520 for vec, 0.504 for228
rowcol, and 0.511 for both grid variants. This narrow band con-229
trasts with p23-¿p1 and p12-¿p3, reinforcing that source-target230
compatibility, not model family alone, governs paired-source231
behavior. 232
5. Discussion233
The dominant and most stable signal is the protocol gap:234
P3 CER is 0.691±0.133, versus 0.180±0.084 for P1 and235
0.145±0.063 for P2. This ordering persists under front-end236
swaps, channel reduction, and low-shot settings, so cross-237
participant mismatch remains the primary error source in this238
audited setup. Layout-aware bias alone is insufficient. Rowcol239
remains close to vec across P1-P3, while grid variants often in-240
crease CER and RTF; patch pooling narrows some gaps but does241
not create a consistent winner. Spatial encoders therefore need242
protocol-specific validation against explicit latency constraints.243
Source aggregation helps at the p4 aggregate level (CER 0.686244
to 0.582), but direction-level outcomes remain heterogeneous.245
Together with k-shot behavior (vec and rowcol improve from246
k1 to k2 while grid variants worsen), this indicates that trans-247
fer benefit depends on source-target compatibility and model248
family. Our practical rule is protocol-specific selection under249
matched audited splits and manifests. We limit all claims to250
these datasets, this normalization pipeline, and these protocol251
definitions, and we do not extrapolate to unaudited populations252
or sensing setups. 253
6. Conclusion254
EPGSpeller provides a reproducible benchmark for lexicon-free255
silent spelling under deterministic audited protocols. Within256
this audited setting, cross-participant transfer remains the hard-257
est regime (P3 CER 0.691±0.133), and paired-source aggre-258
gation can reduce aggregate p4 error (0.686 to 0.582) with-259
out removing direction dependence. Deployment claims should260
therefore be validated per protocol, per target, and per latency261
constraint. 262
7. Artifacts and Auditability263
This repository uses a strict paper registry that pins every ev-264
idence file by checksum and rejects unsupported manuscript265
blocks. The split manifests, aggregated metrics, compact ta-266
bles, statistical summaries, and analysis reports referenced in267
this paper are stored as deterministic artifacts, enabling audit268
and reproduction within our repository environment. A supple-269
mentary archive includes the compact statistical summary table270
for reviewers. 271
8. Ethics and Disclosure272
We report results only for audited artifacts and do not claim273
broader demographic coverage. The datasets and splits used in274
this study are derived from participant recordings, and we focus275
on methodological clarity and artifact traceability rather than276
deployment claims. We used generative AI tools for language277
polishing and verified technical claims against audited artifacts.278

=== PAGE 5 ===
9. References279
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and280
J. Brumberg, “Silent speech interfaces,” 2010.281
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction282
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and283
Computer Engineering. Springer, 2017.284
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,285
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces286
for speech restoration: A review,” 2020.287
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,288
“New developments in electropalatography: A state-of-the-art re-289
port,” 1989.290
[5] W. J. Hardcastle, “Electropalatography in phonetic research and291
in speech training,” 1990.292
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and293
S. Lee, “Biosignal sensors and deep learning-based speech recog-294
nition: A review,” 2021.295
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,296
“Visualisation and analysis of speech production with elec-297
tropalatography,” 2019.298
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and299
evaluation of korean electropalatography (k-epg),” 2021.300
[9] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-301
tion of electropalatographic data using latent variable models,”302
1998.303
[10] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-304
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-305
the-ear silently spelled expressions,” 2024.306
[11] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,307
and P. Green, “Isolated word recognition of silent speech using308
magnetic implants and sensors,” 2010.309
[12] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-310
nectionist temporal classification,” 2006.311
[13] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction312
methods and their implications for studies of lingual coarticula-313
tion,” 1991.314
[14] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and315
M. Stone, “Development of a silent speech interface driven by316
ultrasound and optical images of the tongue and lips,” 2010.317
[15] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,318
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-319
wards mobile, hands-free, silent speech text entry using elec-320
tropalatography,” 2022.321
[16] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth mea-322
surement of face and palate by structured light,” 1993.323
[17] A. Toutios and K. Margaritis, “Learning electropalatograms from324
acoustics,” 2006.325
[18] ——, “On the acoustic-to-electropalatographic mapping,” 2006.326
[19] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph, E. D. Cubuk,327
and Q. V . Le, “Specaugment: A simple data augmentation method328
for automatic speech recognition,” 2019.329
