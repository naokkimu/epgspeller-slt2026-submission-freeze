...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "7d7fc9b670098fcf22bff94ae4763984e97505adeedf99ddf495922d706158ca",
    "sha8": "7d7fc9b6",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "dd5c1402204aeac14cf6d4bd24e760a0b68058c52ef629caa10264b8e8c6335f",
    "sha8": "dd5c1402"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_7d7fc9b6_dd5c1402"
}
```
...
tbl indicates the source result table, grp encodes participant
indices with arrow notation and MS denotes multi source rows,
var indicates the model or method, mean sd reports mean with
standard deviation, ci reports the t distribution interval, and p
adj reports Holm adjusted paired tests.
...
ms 23¿1 vec 0.47±0.01 [0.45,0.50]
ms 23¿1 rowcol 0.48±0.01 [0.45,0.50] 1.00
ms 23¿1 grid 0.60±0.08 [0.48,0.72] 0.34
ms 23¿1 grid aug 0.69±0.16 [0.43,0.95] 0.51
ms 13¿2 vec 0.52±0.00 [0.52,0.52]
ms 13¿2 rowcol 0.50±0.01 [0.49,0.52] 0.51
ms 13¿2 grid 0.51±0.05 [0.44,0.59] 1.00
ms 13¿2 grid aug 0.51±0.02 [0.49,0.54] 0.87
ms 12¿3 vec 0.84±0.03 [0.78,0.89]
ms 12¿3 rowcol 0.79±0.03 [0.74,0.84] 0.73
ms 12¿3 grid 0.74±0.02 [0.71,0.77] 0.11
ms 12¿3 grid aug 0.76±0.02 [0.72,0.79] 0.11
ks 3k1 vec 0.35±0.06 [0.25,0.45]
ks 3k1 rowcol 0.33±0.04 [0.27,0.40] 0.24
ks 3k1 grid 0.52±0.05 [0.44,0.59] 0.06
ks 3k1 grid aug 0.61±0.16 [0.36,0.86] 0.15
ks 3k2 vec 0.25±0.01 [0.23,0.26]
ks 3k2 rowcol 0.28±0.02 [0.24,0.31] 0.13
ks 3k2 grid 0.62±0.13 [0.41,0.83] 0.06
ks 3k2 grid aug 0.69±0.22 [0.34,1.04] 0.10
to4 P3 1¿4 vec 0.67±0.02 [0.63,0.70]
to4 P3 2¿4 vec 0.81±0.02 [0.78,0.84]
to4 P3 3¿4 vec 0.58±0.02 [0.56,0.61]
to4 MS 12¿4 vec 0.65±0.02 [0.63,0.68]
to4 MS 13¿4 vec 0.54±0.01 [0.52,0.55]
to4 MS 23¿4 vec 0.55±0.00 [0.55,0.56]
