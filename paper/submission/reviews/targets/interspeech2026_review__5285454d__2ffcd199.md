...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "5285454d22c7ad889ff91d867f25d34d881ae4cc13fd2f178de99e1d5fdf3b8d",
    "sha8": "5285454d",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "2ffcd1994ca687a10df4ac47bc8062752a988917f4ecbbbe1332ea9647243726",
    "sha8": "2ffcd199"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_5285454d_2ffcd199"
}
```
...
The baseline summary table reports performance across the155
...
three evaluation protocols.156
The baseline summary shows a clear protocol ordering:157
...
The spatial comparison table evaluates vector, row/col, and162
grid-based front ends at full channels across protocols.163
In the spatial comparison, rowcol tracks vec across proto-164
...
winners. 170
The cross-participant transfer summary table evaluates par-171
ticipant p4 as target under single-source and paired-source set-172
tings. 173
The p4 transfer summary shows an aggregate gain: CER174
...
The low-shot summary table evaluates adaptation by vary-179
ing the number of training instances per word for a new partici-180
pant. 181
...
Increasing from k1 to k2 improves vec (0.350-¿0.246) and182
rowcol (0.334-¿0.278), but worsens grid (0.515-¿0.616) and183
grid aug (0.611-¿0.689). Low-shot gain is architecture depen-184
dent, not automatic.185
The reduced-channel summary table evaluates within-186
participant, transfer, and random subset strategies across pro-187
tocols.188
...
At K=64, method deltas are small: P1 CER ranges 0.191-189
0.205, P2 ranges 0.154-0.158, and P3 ranges 0.644-0.657. Be-190
cause these ranges overlap strongly, we avoid a universal rank-191
ing among topk, fps2k, xfer, and rand.192
The electrode-budget trend figure visualizes how accuracy193
and streaming cost vary for the word holdout protocol.194
0.10
0.15
0.20
CER
...
The electrode-budget trend figure shows CER improving195
as K increases toward full channels, while RTF changes less196
steeply. Random subsets remain below within-participant se-197
lections across most K, although the absolute gap narrows at198
larger budgets. 199
The paired-source transfer table evaluates cross-participant200
transfer under the same target and protocol constraints.201
...
=== PAGE 4 ===
Paired-source outcomes are target dependent: for p23-¿p1,202
vec 0.473 and rowcol 0.476 outperform grid 0.602 and gridaug203
0.691, while for p12-¿p3, grid 0.736 outperforms vec 0.838204
and rowcol 0.790. Multi-source benefit is therefore conditional205
rather than universal.206
5. Discussion207
The dominant and most stable signal is the protocol gap:208
P3 CER is 0.691±0.133, versus 0.180±0.084 for P1 and209
0.145±0.063 for P2. This ordering persists under front-end210
swaps, channel reduction, and low-shot settings, so cross-211
participant mismatch remains the primary error source in this212
audited setup. Layout-aware bias alone is insufficient. Rowcol213
remains close to vec across P1-P3, while grid variants often in-214
crease CER and RTF; patch pooling narrows some gaps but does215
not create a consistent winner. Spatial encoders therefore need216
protocol-specific validation against explicit latency constraints.217
Source aggregation helps at the p4 aggregate level (CER 0.686218
to 0.582), but direction-level outcomes remain heterogeneous.219
Together with k-shot behavior (vec and rowcol improve from220
k1 to k2 while grid variants worsen), this indicates that trans-221
fer benefit depends on source-target compatibility and model222
family. Our practical rule is protocol-specific selection under223
matched audited splits and manifests. We limit all claims to224
these datasets, this normalization pipeline, and these protocol225
definitions, and we do not extrapolate to unaudited populations226
or sensing setups.227
6. Conclusion228
EPGSpeller provides a reproducible benchmark for lexicon-free229
silent spelling under deterministic audited protocols. Within230
this audited setting, cross-participant transfer remains the hard-231
est regime (P3 CER 0.691±0.133), and paired-source aggre-232
gation can reduce aggregate p4 error (0.686 to 0.582) with-233
out removing direction dependence. Deployment claims should234
therefore be validated per protocol, per target, and per latency235
constraint.236
7. Artifacts and Auditability237
...
blocks. The split manifests, aggregated metrics, compact ta-240
bles, statistical summaries, and analysis reports referenced in241
this paper are stored as deterministic artifacts, enabling audit242
and reproduction within our repository environment. A supple-243
mentary archive includes the compact statistical summary table244
for reviewers.245
8. Ethics and Disclosure246
...
deployment claims. We used generative AI tools for language251
polishing and verified technical claims against audited artifacts.252

=== PAGE 5 ===
9. References253
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and254
J. Brumberg, “Silent speech interfaces,” 2010.255
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction256
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and257
Computer Engineering. Springer, 2017.258
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,259
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces260
for speech restoration: A review,” 2020.261
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,262
“New developments in electropalatography: A state-of-the-art re-263
port,” 1989.264
[5] W. J. Hardcastle, “Electropalatography in phonetic research and265
in speech training,” 1990.266
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and267
S. Lee, “Biosignal sensors and deep learning-based speech recog-268
nition: A review,” 2021.269
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,270
“Visualisation and analysis of speech production with elec-271
tropalatography,” 2019.272
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and273
evaluation of korean electropalatography (k-epg),” 2021.274
[9] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-275
tion of electropalatographic data using latent variable models,”276
1998.277
[10] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-278
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-279
the-ear silently spelled expressions,” 2024.280
[11] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,281
and P. Green, “Isolated word recognition of silent speech using282
magnetic implants and sensors,” 2010.283
[12] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-284
nectionist temporal classification,” 2006.285
[13] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction286
methods and their implications for studies of lingual coarticula-287
tion,” 1991.288
[14] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and289
M. Stone, “Development of a silent speech interface driven by290
ultrasound and optical images of the tongue and lips,” 2010.291
[15] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,292
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-293
wards mobile, hands-free, silent speech text entry using elec-294
tropalatography,” 2022.295
[16] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth mea-296
surement of face and palate by structured light,” 1993.297
[17] A. Toutios and K. Margaritis, “Learning electropalatograms from298
acoustics,” 2006.299
[18] ——, “On the acoustic-to-electropalatographic mapping,” 2006.300
[19] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph, E. D. Cubuk,301
and Q. V . Le, “Specaugment: A simple data augmentation method302
for automatic speech recognition,” 2019.303
