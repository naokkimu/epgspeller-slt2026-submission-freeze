...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "024136959c99db769d424f7ef1d3e6b34f588d1e432236c1f9780db9e4e0c21f",
    "sha8": "02413695",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "5bb04408dc584efe8859144c6be529c4d0af81517e96779ae8fde277b4b9560c",
    "sha8": "5bb04408"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_02413695_5bb04408"
}
```
...
We compare vector, row/col, and grid-based front ends at162
full channels across protocols.163
Row and column pooling tends to track the vector baseline164
more closely, while grid variants increase error and streaming165
cost across protocols.166
We evaluate low-shot adaptation by varying the number of167
training instances per word for a new participant.168
Two-shot generally improves over one-shot, while layout-169
aware variants remain mixed relative to the vector baseline.170
...
We evaluate cross-participant transfer with the fourth par-180
ticipant as target under single-source and paired-source settings.181
Paired-source transfer is often lower error than single-182
source transfer, but direction-level outcomes are mixed.183
0.10
0.15
0.20
CER
...
=== PAGE 4 ===
Table 6:Cross participant generalization targeting the fourth
