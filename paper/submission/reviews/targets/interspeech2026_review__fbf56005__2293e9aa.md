...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "fbf56005693cccf3388ccb9320923d2d34c4b093f23890dd70d4f6a55ece236c",
    "sha8": "fbf56005",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "2293e9aa1a4b65bc50444ea3ff654e61f8355de3492e458a1cff5f28f899d0a7",
    "sha8": "2293e9aa"
  }
}
```
...
```json
{
  "checks": [
    ...
    },
    {
      ...
      "id": "abstract_length",
      "message": "abstract_chars=963 <= max_characters=1000",
      "ok": true,
      "severity": "info"
    },
    {
  ...
  "run_id": "INTSP2026_STATIC_fbf56005_2293e9aa"
}
```
...
Abstract1
Silent spelling results are hard to compare when stud-2
ies mix word holdout, seen-word instance holdout, and cross-3
participant transfer. We present EPGSpeller, an evidence-4
tracked benchmark for lexicon-free electropalatography (EPG)5
decoding with deterministic splits, checksum-pinned artifacts,6
and a shared CER/LEX/RTF harness for protocol-matched7
comparison. In 652 audited runs, P1 and P2 remain low-error8
(CER 0.180+/-0.084 and 0.145+/-0.063), while P3 is much9
harder (CER 0.691+/-0.133), marking transfer mismatch as the10
main bottleneck. At full channels, rowcol stays closest to vec,11
while grid variants are usually higher in CER and RTF. For12
p4 target transfer, paired-source aggregation improves the all-13
direction aggregate (CER 0.686+/-0.114 to 0.582+/-0.064; LEX14
0.659+/-0.073 to 0.554+/-0.034), but direction-level effects re-15
main mixed. We therefore treat deployment claims as protocol-16
specific and limit conclusions to audited datasets and defini-17
tions.18
