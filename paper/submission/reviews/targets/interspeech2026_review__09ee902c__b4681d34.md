...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "09ee902cce33cc2137015bebd0236e7fa468f81c8448fbfffa34f4e94d3d34b6",
    "sha8": "09ee902c",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "b4681d3462f6013d196253384cc8b3397891424a0dd17cc3eec632a2399847e8",
    "sha8": "b4681d34"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_09ee902c_b4681d34"
}
```
...
\title{EPGSpeller: Reproducible Character-Level Silent Spelling with Audited Protocols and Cross-Participant Evaluation}
...
=== PAGE 1 ===
EPGSpeller: Reproducible Character-Level Silent Spelling with Audited
Protocols and Cross-Participant Evaluation
...
Claim: protocol-level auditability is a first-order require-50
ment for defensible progress in EPG silent spelling.51
...
We evaluate reduced-channel subsets across protocols using170
within-participant, transfer, and random selection strategies.171
Within-participant selection tends to track the full-channel172
baseline more closely than transfer or random subsets, though173
patterns remain mixed across protocols.174
...
[9] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-251
tion of electropalatographic data using latent variable models,”252
1998.253
[10] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-254
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-255
the-ear silently spelled expressions,” 2024.256
[11] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,257
and P. Green, “Isolated word recognition of silent speech using258
magnetic implants and sensors,” 2010.259
[12] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-260
nectionist temporal classification,” 2006.261
[13] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction262
methods and their implications for studies of lingual coarticula-263
tion,” 1991.264
[14] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and265
...
[15] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,268
