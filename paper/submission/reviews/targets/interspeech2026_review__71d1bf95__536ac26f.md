...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "71d1bf9592056e3597a5bcb6787b1d63787c637abc979ae38a3e858b5e58a025",
    "sha8": "71d1bf95",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "536ac26fc71773e3800a1ef2ad4a8726ae4e135fbd418aab5e3169644086cf7b",
    "sha8": "536ac26f"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_71d1bf95_536ac26f"
}
```
...
We evaluate cross-participant transfer with the fourth par-167
ticipant as target under single-source and paired-source settings.168
Paired-source transfer is often lower error than single-169
source transfer, but direction-level outcomes are mixed.170

=== PAGE 3 ===
Table 4:Cross participant generalization targeting the fourth
...
We evaluate paired-source cross-participant transfer under175
the same target and protocol constraints.176
Paired-source transfer is mixed across targets and front177
ends.178
