...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "b6dc41c5e79bb6878decb750db70ce7f22562ce7872c046436b300b2ffb3655d",
    "sha8": "b6dc41c5",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "acd9c39daac1c0d5e5f6b1eb722012368071459a229b643f9135cc2bcb20fe99",
    "sha8": "acd9c39d"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_b6dc41c5_acd9c39d"
}
```
...
the primary accuracy metric, and paired t tests with Holm cor-128
rection within each table.129
3. Models130
...
and paired tests for the primary accuracy metric across the main175
comparisons. 176
The interval estimates quantify uncertainty around the177
mean, and the Holm adjusted paired tests distinguish clearer178
differences from comparisons that remain inconclusive under179
this analysis. 180
5. Discussion181
...
blocks. The split manifests, aggregated metrics, compact tables,199
and analysis summaries referenced in this paper are stored as200
deterministic artifacts, enabling audit and reproduction within201
our repository environment. The same artifacts are reused to202
build the manuscript tables and to support verification in the203
audit views.204
...
deployment claims.210
8. Generative AI Use Disclosure211
We used generative AI tools for language polishing and format-212
ting support, and we verified technical claims against audited213
artifacts.214
...
9. References215
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and216
J. Brumberg, “Silent speech interfaces,” 2010.217
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction218
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and219
Computer Engineering. Springer, 2017.220
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,221
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces222
for speech restoration: A review,” 2020.223
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,224
“New developments in electropalatography: A state-of-the-art re-225
port,” 1989. 226
[5] W. J. Hardcastle, “Electropalatography in phonetic research and227
in speech training,” 1990.228
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and229
S. Lee, “Biosignal sensors and deep learning-based speech recog-230
nition: A review,” 2021.231
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,232
“Visualisation and analysis of speech production with elec-233
tropalatography,” 2019.234
...
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and235
evaluation of korean electropalatography (k-epg),” 2021.236
[9] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-237
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-238
the-ear silently spelled expressions,” 2024.239
[10] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,240
and P. Green, “Isolated word recognition of silent speech241
using magnetic implants and sensors,” 2010. [Online]. Available:242
https://pubmed.ncbi.nlm.nih.gov/20863739/243
[11] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-244
nectionist temporal classification,” 2006.245
[12] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and246
M. Stone, “Development of a silent speech interface driven by247
ultrasound and optical images of the tongue and lips,” 2010.248
[13] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,249
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-250
wards mobile, hands-free, silent speech text entry using elec-251
tropalatography,” 2022.252
[14] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-253
tion of electropalatographic data using latent variable models,”254
1998.255
[15] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction256
methods and their implications for studies of lingual coarticula-257
tion,” 1991.258
[16] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth mea-259
surement of face and palate by structured light,” 1993.260
[17] A. Toutios and K. Margaritis, “Learning electropalatograms from261
acoustics,” 2006.262
[18] ——, “On the acoustic-to-electropalatographic mapping,” 2006.263
[19] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph, E. D. Cubuk,264
and Q. V . Le, “Specaugment: A simple data augmentation method265
for automatic speech recognition,” 2019.266
Table 7:Statistical summary for the primary accuracy metric;
tbl indicates the source result table, grp indicates the protocol
or group, var indicates the model or method, mean sd reports
mean with standard deviation, ci reports the t distribution inter-
val, and p adj reports Holm adjusted paired tests.
tbl grp var n mean sd ci p adj
spatial all P1 vec 4 0.1796±0.0844 [0.0453,0.3139]
spatial all P1 rowcol 4 0.2016±0.0886 [0.0607,0.3426] 0.0986
spatial all P1 grid 4 0.3062±0.1491 [0.0690,0.5435] 1.0000
spatial all P1 grid aug 4 0.3094±0.1440 [0.0802,0.5385] 0.7686
spatial all P1 patch 4 0.2982±0.0666 [0.1922,0.4041] 0.0986
spatial all P1 patch aug 4 0.2988±0.0891 [0.1569,0.4406] 0.5362
spatial all P2 vec 3 0.1451±0.0627 [-0.0108,0.3009]
spatial all P2 rowcol 3 0.1613±0.0783 [-0.0332,0.3558] 1.0000
spatial all P2 grid 3 0.2894±0.2126 [-0.2387,0.8174] 1.0000
spatial all P2 grid aug 3 0.3139±0.2436 [-0.2913,0.9190] 1.0000
spatial all P2 patch 3 0.3384±0.2324 [-0.2388,0.9157] 1.0000
spatial all P2 patch aug 3 0.3014±0.1626 [-0.1025,0.7052] 1.0000
spatial all P3 vec 6 0.6909±0.1332 [0.5511,0.8306]
spatial all P3 rowcol 6 0.6828±0.1510 [0.5243,0.8412] 1.0000
spatial all P3 grid 6 0.7507±0.0897 [0.6566,0.8448] 1.0000
spatial all P3 grid aug 6 0.7559±0.0920 [0.6593,0.8525] 1.0000
spatial all P3 patch 6 0.6898±0.1103 [0.5740,0.8055] 1.0000
spatial all P3 patch aug 6 0.6992±0.1305 [0.5623,0.8361] 1.0000
k64 all P1 topk 4 0.1952±0.0827 [0.0636,0.3268]
k64 all P1 fps2k 4 0.1912±0.0781 [0.0669,0.3156] 1.0000
k64 all P1 xfer 4 0.2053±0.0951 [0.0540,0.3565] 1.0000
k64 all P1 rand 4 0.1980±0.0793 [0.0717,0.3242] 1.0000
k64 all P2 topk 3 0.1544±0.0591 [0.0076,0.3012]
k64 all P2 fps2k 3 0.1539±0.0617 [0.0007,0.3071] 1.0000
k64 all P2 xfer 3 0.1584±0.0709 [-0.0178,0.3346] 1.0000
k64 all P2 rand 3 0.1566±0.0669 [-0.0097,0.3229] 1.0000
k64 all P3 topk 6 0.6473±0.1301 [0.5108,0.7838]
k64 all P3 fps2k 6 0.6564±0.1465 [0.5026,0.8101] 1.0000
k64 all P3 xfer 6 0.6569±0.1441 [0.5057,0.8081] 1.0000
k64 all P3 rand 6 0.6442±0.1328 [0.5048,0.7836] 1.0000
p3ms p23-¿p1 vec 4 0.4735±0.0136 [0.4518,0.4952]
p3ms p23-¿p1 rowcol 4 0.4759±0.0138 [0.4540,0.4978] 1.0000
p3ms p23-¿p1 grid 4 0.6020±0.0765 [0.4803,0.7237] 0.3351
p3ms p23-¿p1 grid aug 4 0.6911±0.1646 [0.4292,0.9529] 0.5097
p3ms p13-¿p2 vec 4 0.5203±0.0029 [0.5158,0.5249]
p3ms p13-¿p2 rowcol 4 0.5042±0.0117 [0.4855,0.5228] 0.5097
p3ms p13-¿p2 grid 4 0.5106±0.0474 [0.4352,0.5860] 1.0000
p3ms p13-¿p2 grid aug 4 0.5114±0.0164 [0.4852,0.5376] 0.8703
p3ms p12-¿p3 vec 4 0.8381±0.0336 [0.7846,0.8915]
p3ms p12-¿p3 rowcol 4 0.7903±0.0328 [0.7381,0.8424] 0.7269
p3ms p12-¿p3 grid 4 0.7362±0.0182 [0.7072,0.7652] 0.1074
p3ms p12-¿p3 grid aug 4 0.7561±0.0197 [0.7248,0.7874] 0.1074
kshot p3 k1 vec 4 0.3503±0.0599 [0.2549,0.4457]
kshot p3 k1 rowcol 4 0.3344±0.0386 [0.2730,0.3959] 0.2413
kshot p3 k1 grid 4 0.5153±0.0500 [0.4357,0.5948] 0.0567
kshot p3 k1 grid aug 4 0.6105±0.1572 [0.3604,0.8607] 0.1522
kshot p3 k2 vec 4 0.2458±0.0085 [0.2323,0.2593]
kshot p3 k2 rowcol 4 0.2782±0.0217 [0.2438,0.3127] 0.1308
kshot p3 k2 grid 4 0.6156±0.1321 [0.4053,0.8258] 0.0567
kshot p3 k2 grid aug 4 0.6889±0.2179 [0.3421,1.0357] 0.1028
to4 P3:p1-¿p4 vec 4 0.6660±0.0237 [0.6283,0.7036]
to4 P3:p2-¿p4 vec 4 0.8091±0.0207 [0.7761,0.8420]
to4 P3:p3-¿p4 vec 4 0.5840±0.0180 [0.5553,0.6127]
to4 P3:all-¿p4 vec 3 0.6863±0.1139 [0.4034,0.9693]
to4 P3MS:p12-¿p4 vec 4 0.6546±0.0161 [0.6290,0.6803]
to4 P3MS:p13-¿p4 vec 4 0.5363±0.0089 [0.5221,0.5505]
to4 P3MS:p23-¿p4 vec 4 0.5547±0.0046 [0.5474,0.5619]
to4 P3MS:all-¿p4 vec 3 0.5819±0.0637 [0.4237,0.7400]
