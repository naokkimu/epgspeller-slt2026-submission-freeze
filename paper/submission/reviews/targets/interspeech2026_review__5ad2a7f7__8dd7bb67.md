...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "5ad2a7f7ba8c84299fc248cc62971aa6eee08cc2703a0cae76b787c98da6bd67",
    "sha8": "5ad2a7f7",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "8dd7bb67a63fd8fa51b9bc03ca4cb24e37ccb6bb0bddd3b9f5a1fe631cfcfa32",
    "sha8": "8dd7bb67"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_5ad2a7f7_8dd7bb67"
}
```
...
We compare vector, row/col, and grid-based front ends at174
full channels across protocols.175
Row and column pooling tends to track the vector baseline176
more closely, while grid variants increase error and streaming177
cost across protocols.178
...
We evaluate reduced-channel subsets across protocols using179
within-participant, transfer, and random selection strategies.180
Within-participant selection tends to track the full-channel181
baseline more closely than transfer or random subsets, though182
patterns remain mixed across protocols.183
We visualize how accuracy and streaming cost vary with184
electrode budget for the word holdout protocol.185
Accuracy improves as electrode budget increases, random186
selection remains weaker than within participant selection, and187
streaming cost varies less than error.188
Table 6:Spatial modeling at full channels across protocols
...
Table 7:Electrode reduction methods across protocols (proto-
...
deployment claims. We used generative AI tools for language218
polishing and verified technical claims against audited artifacts.219

=== PAGE 5 ===
8. References220
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and221
J. Brumberg, “Silent speech interfaces,” 2010.222
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction223
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and224
Computer Engineering. Springer, 2017.225
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,226
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces227
for speech restoration: A review,” 2020.228
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,229
“New developments in electropalatography: A state-of-the-art re-230
port,” 1989.231
[5] W. J. Hardcastle, “Electropalatography in phonetic research and232
in speech training,” 1990.233
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and234
S. Lee, “Biosignal sensors and deep learning-based speech recog-235
nition: A review,” 2021.236
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,237
“Visualisation and analysis of speech production with elec-238
tropalatography,” 2019.239
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and240
evaluation of korean electropalatography (k-epg),” 2021.241
[9] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-242
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-243
the-ear silently spelled expressions,” 2024.244
[10] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,245
and P. Green, “Isolated word recognition of silent speech246
using magnetic implants and sensors,” 2010. [Online]. Available:247
https://pubmed.ncbi.nlm.nih.gov/20863739/248
[11] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-249
nectionist temporal classification,” 2006.250
[12] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and251
M. Stone, “Development of a silent speech interface driven by252
ultrasound and optical images of the tongue and lips,” 2010.253
[13] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,254
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-255
wards mobile, hands-free, silent speech text entry using elec-256
tropalatography,” 2022.257
[14] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-258
tion of electropalatographic data using latent variable models,”259
1998.260
[15] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction261
methods and their implications for studies of lingual coarticula-262
tion,” 1991.263
[16] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth mea-264
surement of face and palate by structured light,” 1993.265
[17] A. Toutios and K. Margaritis, “Learning electropalatograms from266
acoustics,” 2006.267
[18] ——, “On the acoustic-to-electropalatographic mapping,” 2006.268
[19] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph, E. D. Cubuk,269
and Q. V . Le, “Specaugment: A simple data augmentation method270
for automatic speech recognition,” 2019.271
