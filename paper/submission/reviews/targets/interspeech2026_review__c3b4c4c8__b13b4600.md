...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "c3b4c4c84aa7c2f69e3eb6e5f94b0f4e6d9f4c2270d9a4b6adbee889c5dc5faa",
    "sha8": "c3b4c4c8",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "b13b460049b383d89bf5c7c686cd3cd37e3db621266e0f55794180843779b0b2",
    "sha8": "b13b4600"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_c3b4c4c8_b13b4600"
}
```
...
We also visualize how streaming speed changes as the elec-180
trode budget varies.181
Streaming cost is lowest at higher budgets and increases as182
channels are removed, with strategy-dependent sensitivity.183
We evaluate paired-source cross-participant transfer under184
the same target and protocol constraints.185
Paired-source transfer is mixed across targets and front186
ends.187
We evaluate low-shot adaptation by varying the number of188
training instances per word for a new participant.189
Two-shot generally improves over one-shot, while layout-190
aware variants remain mixed relative to the vector baseline.191
5. Discussion192
Across protocols, layout-aware front ends do not consistently193
outperform the vector baseline and often increase streaming194
cost; the patchpool grid reduces but does not eliminate the gap.195
Cross-participant transfer remains the main bottleneck. Source196
aggregation and low-shot adaptation help in some settings, but197
outcomes are mixed, and simple similarity indicators do not198
yield a single rule for when multi-source helps. Design implica-199
tion: when low latency is the priority, the vector or row/col front200
ends are safer choices; when robustness to electrode dropout201
or spatial priors is desired, grid-based options require careful202
tuning and validation. These takeaways depend on the audited203
datasets, split protocols, and evaluation pipeline, and they may204
not transfer to other sensors, labeling schemes, or participant205
populations.206
...
run set.
6. Artifacts and Auditability207
This repository uses a strict paper registry that pins every ev-208
idence file by checksum and rejects unsupported manuscript209
blocks. The split manifests, aggregated metrics, compact ta-210
bles, statistical summaries, and analysis reports referenced in211
this paper are stored as deterministic artifacts, enabling audit212
and reproduction within our repository environment. A supple-213
mentary archive includes the compact statistical summary table214
for reviewers. 215
7. Ethics and Disclosure216
...
8. Generative AI Use Disclosure222
We used generative AI tools for language polishing and format-223
ting support, and we verified technical claims against audited224
artifacts. 225

=== PAGE 4 ===
Figure 2:Streaming speed versus electrode budget in an audited
run set.
...
=== PAGE 5 ===
9. References226
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and227
J. Brumberg, “Silent speech interfaces,” 2010.228
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction229
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and230
Computer Engineering. Springer, 2017.231
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,232
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces233
for speech restoration: A review,” 2020.234
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,235
“New developments in electropalatography: A state-of-the-art re-236
port,” 1989.237
[5] W. J. Hardcastle, “Electropalatography in phonetic research and238
in speech training,” 1990.239
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and240
S. Lee, “Biosignal sensors and deep learning-based speech recog-241
nition: A review,” 2021.242
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,243
“Visualisation and analysis of speech production with elec-244
tropalatography,” 2019.245
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and246
evaluation of korean electropalatography (k-epg),” 2021.247
[9] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-248
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-249
the-ear silently spelled expressions,” 2024.250
[10] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,251
and P. Green, “Isolated word recognition of silent speech252
using magnetic implants and sensors,” 2010. [Online]. Available:253
https://pubmed.ncbi.nlm.nih.gov/20863739/254
[11] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-255
nectionist temporal classification,” 2006.256
[12] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and257
M. Stone, “Development of a silent speech interface driven by258
ultrasound and optical images of the tongue and lips,” 2010.259
[13] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,260
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-261
wards mobile, hands-free, silent speech text entry using elec-262
tropalatography,” 2022.263
[14] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-264
tion of electropalatographic data using latent variable models,”265
1998.266
[15] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction267
methods and their implications for studies of lingual coarticula-268
tion,” 1991.269
[16] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth mea-270
surement of face and palate by structured light,” 1993.271
[17] A. Toutios and K. Margaritis, “Learning electropalatograms from272
acoustics,” 2006.273
[18] ——, “On the acoustic-to-electropalatographic mapping,” 2006.274
[19] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph, E. D. Cubuk,275
and Q. V . Le, “Specaugment: A simple data augmentation method276
for automatic speech recognition,” 2019.277
