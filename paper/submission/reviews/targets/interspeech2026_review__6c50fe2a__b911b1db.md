...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "6c50fe2ac4ffa55c1f60e5e6472ca4f656e02baef28dc94cdbc8e289692a8678",
    "sha8": "6c50fe2a",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "b911b1db3456f74e1fd3923d43457470171e5a4ff35b84dae76174faaa667eca",
    "sha8": "b911b1db"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_6c50fe2a_b911b1db"
}
```
...
We evaluate paired-source cross-participant transfer under176
the same target and protocol constraints.177
...
Paired-source transfer is mixed across targets and front178
ends.179
We evaluate low-shot adaptation by varying the number of180
training instances per word for a new participant.181
Two-shot generally improves over one-shot, while layout-182
aware variants remain mixed relative to the vector baseline.183
5. Discussion184
...
Cross-participant transfer remains the main bottleneck. Source188
aggregation and low-shot adaptation help in some settings, but189
outcomes are mixed, and simple similarity indicators do not190
yield a single rule for when multi-source helps. Design implica-191
tion: when low latency is the priority, the vector or row/col front192
ends are safer choices; when robustness to electrode dropout193
or spatial priors is desired, grid-based options require careful194
tuning and validation. These takeaways depend on the audited195
datasets, split protocols, and evaluation pipeline, and they may196
not transfer to other sensors, labeling schemes, or participant197
populations.198
6. Artifacts and Auditability199
This repository uses a strict paper registry that pins every ev-200
idence file by checksum and rejects unsupported manuscript201
blocks. The split manifests, aggregated metrics, compact ta-202
bles, statistical summaries, and analysis reports referenced in203
this paper are stored as deterministic artifacts, enabling audit204
and reproduction within our repository environment. A supple-205
mentary archive includes the compact statistical summary table206
for reviewers.207
...
7. Ethics and Disclosure208
We report results only for audited artifacts and do not claim209
broader demographic coverage. The datasets and splits used in210
this study are derived from participant recordings, and we focus211
on methodological clarity and artifact traceability rather than212
deployment claims. 213
8. Generative AI Use Disclosure214
We used generative AI tools for language polishing and format-215
ting support, and we verified technical claims against audited216
artifacts. 217
...
9. References218
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and219
J. Brumberg, “Silent speech interfaces,” 2010.220
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction221
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and222
Computer Engineering. Springer, 2017.223
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,224
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces225
for speech restoration: A review,” 2020.226
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,227
“New developments in electropalatography: A state-of-the-art re-228
port,” 1989.229
[5] W. J. Hardcastle, “Electropalatography in phonetic research and230
in speech training,” 1990.231
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and232
S. Lee, “Biosignal sensors and deep learning-based speech recog-233
nition: A review,” 2021.234
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,235
“Visualisation and analysis of speech production with elec-236
tropalatography,” 2019.237
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and238
evaluation of korean electropalatography (k-epg),” 2021.239
[9] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-240
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-241
the-ear silently spelled expressions,” 2024.242
[10] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,243
and P. Green, “Isolated word recognition of silent speech244
using magnetic implants and sensors,” 2010. [Online]. Available:245
https://pubmed.ncbi.nlm.nih.gov/20863739/246
[11] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-247
nectionist temporal classification,” 2006.248
[12] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and249
M. Stone, “Development of a silent speech interface driven by250
ultrasound and optical images of the tongue and lips,” 2010.251
[13] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,252
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-253
wards mobile, hands-free, silent speech text entry using elec-254
tropalatography,” 2022.255
[14] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-256
tion of electropalatographic data using latent variable models,”257
1998.258
[15] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction259
methods and their implications for studies of lingual coarticula-260
tion,” 1991.261
[16] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth mea-262
surement of face and palate by structured light,” 1993.263
[17] A. Toutios and K. Margaritis, “Learning electropalatograms from264
acoustics,” 2006. 265
[18] ——, “On the acoustic-to-electropalatographic mapping,” 2006.266
[19] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph, E. D. Cubuk,267
and Q. V . Le, “Specaugment: A simple data augmentation method268
for automatic speech recognition,” 2019.269
