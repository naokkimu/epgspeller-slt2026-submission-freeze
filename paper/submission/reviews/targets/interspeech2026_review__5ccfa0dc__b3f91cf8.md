...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "5ccfa0dc58c2661ac44151a1e2aff64abe110929f42ccddf8043d9ceade1d573",
    "sha8": "5ccfa0dc",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "b3f91cf808a952cb8e4f542d42b8118fcfebba5ec869e439d30628ccecd17d4f",
    "sha8": "b3f91cf8"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_5ccfa0dc_b3f91cf8"
}
```
...
manifest artifact. Group labels use p with source identifiers and108
an arrow to the target, and paired sources concatenate. In our109
audited splits, the multi source aggregation reduces CER rela-110
tive to the single source aggregation for the same target.111
...
paired source participants. The group labels concatenate the132
two source identifiers and use an arrow to the target identifier.133
The multi source table reports direction level results for vector134
and layout aware front ends.135
