...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "389578c3d12d6a243dd0671a58027cdd5301a41e9ba42dbc3f7db47972e9fc91",
    "sha8": "389578c3",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "a8854eb3073dc5d731db87cd5a97e426c0a87b55796adc1a1b257582bac3961a",
    "sha8": "a8854eb3"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_389578c3_a8854eb3"
}
```
...
We visualize how accuracy and streaming cost vary with174
electrode budget for the word holdout protocol.175
Accuracy improves as electrode budget increases, random176
selection remains weaker than within participant selection, and177
streaming cost varies less than error.178
...
We compare vector, row/col, and grid-based front ends at179
full channels across protocols.180
Row and column pooling tends to track the vector baseline181
more closely, while grid variants increase error and streaming182
cost across protocols.183
We evaluate reduced-channel subsets across protocols using184
within-participant, transfer, and random selection strategies.185
Within-participant selection tends to track the full-channel186
baseline more closely than transfer or random subsets, though187
patterns remain mixed across protocols.188
0.10
0.15
0.20
CER
