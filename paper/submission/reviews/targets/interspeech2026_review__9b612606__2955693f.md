...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "9b61260694618c58c0dc3ba09f6061895140c680def50964679a7b0d281e4d55",
    "sha8": "9b612606",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "2955693f1b282de30e57d451dbafa1a7b7219d6d23c929dc7a6dde31ecf93008",
    "sha8": "2955693f"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_9b612606_2955693f"
}
```
...
Row/col tracks the vector baseline more closely than grid168
variants. Grid variants tend to worsen accuracy and increase169
latency, and patchpool reduces but does not remove this gap.170
We evaluate reduced-channel subsets using within-171
participant, transfer, and random selection strategies.172
We detail electrode reduction methods for the word and in-173
stance holdout protocols.174
Within-participant selection stays closer to the baseline than175
transfer or random subsets, though the pattern is not uniform176
across protocols. 177
...
Table 5:Electrode reduction methods for word and instance
holdout protocols.
...
We separate electrode reduction results for the cross partic-178
ipant protocol.179
Across-subject selection remains mixed and no single180
method consistently dominates.181
Within-participant selection is similar to the vector base-182
line, while transfer and random subsets are generally lower and183
mixed across protocols.184
We evaluate paired-source cross-participant transfer under185
the same target and protocol constraints.186
Paired-source transfer is mixed across targets and front187
ends.188
We evaluate low-shot adaptation by varying the number of189
training instances per word for a new participant.190
Two-shot generally improves over one-shot, while layout-191
aware variants remain mixed relative to the vector baseline.192
5. Discussion193
Across protocols, layout-aware front ends do not consistently194
outperform the vector baseline and often increase streaming195
cost; the patchpool grid reduces but does not eliminate the gap.196
Cross-participant transfer remains the main bottleneck. Source197
Table 6:Electrode reduction methods for the cross participant
protocol.
method cer rtf
...
aggregation and low-shot adaptation help in some settings, but198
outcomes are mixed, and simple similarity indicators do not199
yield a single rule for when multi-source helps. Design implica-200
tion: when low latency is the priority, the vector or row/col front201
ends are safer choices; when robustness to electrode dropout202
or spatial priors is desired, grid-based options require careful203
tuning and validation. These takeaways depend on the audited204
datasets, split protocols, and evaluation pipeline, and they may205
not transfer to other sensors, labeling schemes, or participant206
populations. 207
6. Artifacts and Auditability208
This repository uses a strict paper registry that pins every ev-209
idence file by checksum and rejects unsupported manuscript210
blocks. The split manifests, aggregated metrics, compact ta-211
bles, statistical summaries, and analysis reports referenced in212
this paper are stored as deterministic artifacts, enabling audit213
and reproduction within our repository environment. A supple-214
mentary archive includes the compact statistical summary table215
for reviewers. 216
7. Ethics and Disclosure217
We report results only for audited artifacts and do not claim218
broader demographic coverage. The datasets and splits used in219
this study are derived from participant recordings, and we focus220
on methodological clarity and artifact traceability rather than221
deployment claims. 222
...
8. Generative AI Use Disclosure223
We used generative AI tools for language polishing and format-224
ting support, and we verified technical claims against audited225
artifacts.226
9. References227
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and228
J. Brumberg, “Silent speech interfaces,” 2010.229
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction230
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and231
Computer Engineering. Springer, 2017.232
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,233
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces234
for speech restoration: A review,” 2020.235
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,236
“New developments in electropalatography: A state-of-the-art re-237
port,” 1989.238
[5] W. J. Hardcastle, “Electropalatography in phonetic research and239
in speech training,” 1990.240
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and241
S. Lee, “Biosignal sensors and deep learning-based speech recog-242
nition: A review,” 2021.243
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,244
“Visualisation and analysis of speech production with elec-245
tropalatography,” 2019.246
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and247
evaluation of korean electropalatography (k-epg),” 2021.248
[9] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-249
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-250
the-ear silently spelled expressions,” 2024.251
[10] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,252
and P. Green, “Isolated word recognition of silent speech253
using magnetic implants and sensors,” 2010. [Online]. Available:254
https://pubmed.ncbi.nlm.nih.gov/20863739/255
[11] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-256
nectionist temporal classification,” 2006.257
[12] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and258
M. Stone, “Development of a silent speech interface driven by259
ultrasound and optical images of the tongue and lips,” 2010.260
[13] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,261
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-262
wards mobile, hands-free, silent speech text entry using elec-263
tropalatography,” 2022.264
[14] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-265
tion of electropalatographic data using latent variable models,”266
1998.267
[15] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction268
methods and their implications for studies of lingual coarticula-269
tion,” 1991. 270
[16] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth mea-271
surement of face and palate by structured light,” 1993.272
[17] A. Toutios and K. Margaritis, “Learning electropalatograms from273
acoustics,” 2006. 274
[18] ——, “On the acoustic-to-electropalatographic mapping,” 2006.275
[19] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph, E. D. Cubuk,276
and Q. V . Le, “Specaugment: A simple data augmentation method277
for automatic speech recognition,” 2019.278
