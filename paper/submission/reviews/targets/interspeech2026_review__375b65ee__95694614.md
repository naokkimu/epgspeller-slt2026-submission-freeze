...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "375b65ee9bb390d35b5efb4955136087b2bb7d7e3c27d08af6d49f80eb639c20",
    "sha8": "375b65ee",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "956946145350d39a4446d4b212af59cb27f672103f407314194408b5ae7fd4dd",
    "sha8": "95694614"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_375b65ee_95694614"
}
```
...
and reproduction within our repository environment. The same196
artifacts are reused to build the manuscript tables and to support197
verification in the audit views.198
