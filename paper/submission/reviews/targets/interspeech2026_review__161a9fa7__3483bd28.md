...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "161a9fa7c407c96f29c693a7ec0a5012dd105a3f0d554654976070eacfcd688d",
    "sha8": "161a9fa7",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "3483bd28d10dc716318261c403a868e11162d63aa74e320abf20939a08f98ca3",
    "sha8": "3483bd28"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_161a9fa7_3483bd28"
}
```
...
streaming cost.
5. Discussion194
Across protocols, layout-aware front ends do not consistently195
outperform the vector baseline and often increase streaming196
cost; the patchpool grid reduces but does not eliminate the gap.197
Cross-participant transfer remains the main bottleneck. Source198
aggregation and low-shot adaptation help in some settings, but199
outcomes are mixed, and simple similarity indicators do not200
yield a single rule for when multi-source helps. Design implica-201
tion: when low latency is the priority, the vector or row/col front202
ends are safer choices; when robustness to electrode dropout203
or spatial priors is desired, grid-based options require careful204
tuning and validation. These takeaways depend on the audited205
datasets, split protocols, and evaluation pipeline, and they may206
not transfer to other sensors, labeling schemes, or participant207
populations.208
6. Artifacts and Auditability209
...
blocks. The split manifests, aggregated metrics, compact ta-212
bles, statistical summaries, and analysis reports referenced in213
this paper are stored as deterministic artifacts, enabling audit214
and reproduction within our repository environment. A supple-215
mentary archive includes the compact statistical summary table216
for reviewers.217
7. Ethics and Disclosure218
We report results only for audited artifacts and do not claim219
broader demographic coverage. The datasets and splits used in220
this study are derived from participant recordings, and we focus221
on methodological clarity and artifact traceability rather than222
deployment claims. 223
8. Generative AI Use Disclosure224
We used generative AI tools for language polishing and format-225
ting support, and we verified technical claims against audited226
artifacts. 227
9. References228
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and229
J. Brumberg, “Silent speech interfaces,” 2010.230
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction231
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and232
Computer Engineering. Springer, 2017.233
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,234
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces235
for speech restoration: A review,” 2020.236
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,237
“New developments in electropalatography: A state-of-the-art re-238
port,” 1989. 239
[5] W. J. Hardcastle, “Electropalatography in phonetic research and240
in speech training,” 1990.241
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and242
S. Lee, “Biosignal sensors and deep learning-based speech recog-243
nition: A review,” 2021.244
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,245
“Visualisation and analysis of speech production with elec-246
tropalatography,” 2019.247
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and248
evaluation of korean electropalatography (k-epg),” 2021.249
[9] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-250
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-251
the-ear silently spelled expressions,” 2024.252
[10] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,253
and P. Green, “Isolated word recognition of silent speech254
using magnetic implants and sensors,” 2010. [Online]. Available:255
https://pubmed.ncbi.nlm.nih.gov/20863739/256
[11] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-257
nectionist temporal classification,” 2006.258
[12] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and259
M. Stone, “Development of a silent speech interface driven by260
ultrasound and optical images of the tongue and lips,” 2010.261
[13] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,262
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-263
wards mobile, hands-free, silent speech text entry using elec-264
tropalatography,” 2022.265
[14] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-266
tion of electropalatographic data using latent variable models,”267
1998. 268
[15] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction269
methods and their implications for studies of lingual coarticula-270
tion,” 1991. 271
[16] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth mea-272
surement of face and palate by structured light,” 1993.273
[17] A. Toutios and K. Margaritis, “Learning electropalatograms from274
acoustics,” 2006. 275
[18] ——, “On the acoustic-to-electropalatographic mapping,” 2006.276
[19] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph, E. D. Cubuk,277
and Q. V . Le, “Specaugment: A simple data augmentation method278
for automatic speech recognition,” 2019.279
