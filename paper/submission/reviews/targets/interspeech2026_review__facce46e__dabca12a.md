...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "facce46e880e44b9fb20add4012425a9284b29e7b480342d7e0b2b71801ce72e",
    "sha8": "facce46e",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "dabca12aeb55e419010115269f85f7136526f0f90b6d5dd3ba8285a9d70bea7c",
    "sha8": "dabca12a"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_facce46e_dabca12a"
}
```
...
We visualize how accuracy and streaming cost vary with166
electrode budget for the word holdout protocol.167
Accuracy improves as electrode budget increases, random168
selection remains weaker than within participant selection, and169
streaming cost varies less than error.170
We compare vector, row/col, and grid-based front ends at171
full channels across protocols.172
Row and column pooling tends to track the vector baseline173
more closely, while grid variants increase error and streaming174
cost across protocols.175
We evaluate low-shot adaptation by varying the number of176
training instances per word for a new participant.177
...
streaming cost.
Two-shot generally improves over one-shot, while layout-178
aware variants remain mixed relative to the vector baseline.179
We evaluate paired-source cross-participant transfer under180
the same target and protocol constraints.181
Paired-source transfer is mixed across targets and front182
ends.183
...
Table 5:Low shot adaptation results for a new participant;
...
cost; the patchpool grid reduces but does not eliminate the187
gap. The pattern suggests spatial structure alone is insufficient188
without careful capacity and regularization choices. Cross-189
participant transfer remains the main bottleneck. Source aggre-190
gation and low-shot adaptation help in some settings, but out-191
comes are mixed, and simple similarity indicators do not yield192
a single rule for when multi-source helps. This variability ar-193
gues for protocol-specific validation rather than assuming trans-194
fer will generalize. Design implication: when low latency is the195
priority, the vector or row/col front ends are safer choices; when196
robustness to electrode dropout or spatial priors is desired, grid-197
based options require careful tuning and validation. In practice,198
the safest workflow is to benchmark both families under the au-199
dited split definitions before committing to a deployment path.200
These takeaways depend on the audited datasets, split proto-201
cols, and evaluation pipeline, and they may not transfer to other202
sensors, labeling schemes, or participant populations. Broader203
participant coverage and longer-term recording stability remain204
outside the current evidence envelope.205
6. Artifacts and Auditability206
This repository uses a strict paper registry that pins every ev-207
idence file by checksum and rejects unsupported manuscript208
blocks. The split manifests, aggregated metrics, compact ta-209
bles, statistical summaries, and analysis reports referenced in210
this paper are stored as deterministic artifacts, enabling audit211
and reproduction within our repository environment. A supple-212
mentary archive includes the compact statistical summary table213
for reviewers.214
7. Ethics and Disclosure215
We report results only for audited artifacts and do not claim216
broader demographic coverage. The datasets and splits used in217
this study are derived from participant recordings, and we focus218
on methodological clarity and artifact traceability rather than219
deployment claims. We used generative AI tools for language220
polishing and verified technical claims against audited artifacts.221

=== PAGE 5 ===
8. References222
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and223
J. Brumberg, “Silent speech interfaces,” 2010.224
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction225
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and226
Computer Engineering. Springer, 2017.227
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,228
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces229
for speech restoration: A review,” 2020.230
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,231
“New developments in electropalatography: A state-of-the-art re-232
port,” 1989.233
[5] W. J. Hardcastle, “Electropalatography in phonetic research and234
in speech training,” 1990.235
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and236
S. Lee, “Biosignal sensors and deep learning-based speech recog-237
nition: A review,” 2021.238
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,239
“Visualisation and analysis of speech production with elec-240
tropalatography,” 2019.241
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and242
evaluation of korean electropalatography (k-epg),” 2021.243
[9] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-244
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-245
the-ear silently spelled expressions,” 2024.246
[10] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,247
and P. Green, “Isolated word recognition of silent speech248
using magnetic implants and sensors,” 2010. [Online]. Available:249
https://pubmed.ncbi.nlm.nih.gov/20863739/250
[11] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-251
nectionist temporal classification,” 2006.252
[12] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and253
M. Stone, “Development of a silent speech interface driven by254
ultrasound and optical images of the tongue and lips,” 2010.255
[13] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,256
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-257
wards mobile, hands-free, silent speech text entry using elec-258
tropalatography,” 2022.259
[14] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-260
tion of electropalatographic data using latent variable models,”261
1998.262
[15] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction263
methods and their implications for studies of lingual coarticula-264
tion,” 1991.265
[16] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth mea-266
surement of face and palate by structured light,” 1993.267
[17] A. Toutios and K. Margaritis, “Learning electropalatograms from268
acoustics,” 2006.269
[18] ——, “On the acoustic-to-electropalatographic mapping,” 2006.270
[19] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph, E. D. Cubuk,271
and Q. V . Le, “Specaugment: A simple data augmentation method272
for automatic speech recognition,” 2019.273
