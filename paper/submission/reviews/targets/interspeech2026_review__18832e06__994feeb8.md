...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "18832e0635f3f79d2f814cbb6578c924974c02bf67220183a75b6ef748c7ee12",
    "sha8": "18832e06",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "994feeb87fd7b2117ac5979c39b448d4a0584967ad1c6f79cb6a97094e95bf63",
    "sha8": "994feeb8"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_18832e06_994feeb8"
}
```
...
Within-participant selection is similar to the vector base-189
line, while transfer and random subsets are generally lower and190
mixed across protocols.191
We evaluate paired-source cross-participant transfer under192
the same target and protocol constraints.193
Paired-source transfer is mixed across targets and front194
ends.195
We evaluate low-shot adaptation by varying the number of196
training instances per word for a new participant.197
Two-shot generally improves over one-shot, while layout-198
aware variants remain mixed relative to the vector baseline.199
5. Discussion200
Across protocols, layout-aware front ends do not consistently201
outperform the vector baseline and often increase streaming202
cost; the patchpool grid reduces but does not eliminate the gap.203
Cross-participant transfer remains the main bottleneck. Source204
aggregation and low-shot adaptation help in some settings, but205
outcomes are mixed, and simple similarity indicators do not206
yield a single rule for when multi-source helps. Design implica-207
tion: when low latency is the priority, the vector or row/col front208
ends are safer choices; when robustness to electrode dropout209
or spatial priors is desired, grid-based options require careful210
tuning and validation. These takeaways depend on the audited211
datasets, split protocols, and evaluation pipeline, and they may212
not transfer to other sensors, labeling schemes, or participant213
populations.214
...
6. Artifacts and Auditability215
...
deployment claims. 229
8. Generative AI Use Disclosure230
We used generative AI tools for language polishing and format-231
ting support, and we verified technical claims against audited232
artifacts. 233
...
=== PAGE 5 ===
9. References234
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and235
J. Brumberg, “Silent speech interfaces,” 2010.236
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction237
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and238
Computer Engineering. Springer, 2017.239
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,240
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces241
for speech restoration: A review,” 2020.242
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,243
“New developments in electropalatography: A state-of-the-art re-244
port,” 1989.245
[5] W. J. Hardcastle, “Electropalatography in phonetic research and246
in speech training,” 1990.247
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and248
S. Lee, “Biosignal sensors and deep learning-based speech recog-249
nition: A review,” 2021.250
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,251
“Visualisation and analysis of speech production with elec-252
tropalatography,” 2019.253
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and254
evaluation of korean electropalatography (k-epg),” 2021.255
[9] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-256
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-257
the-ear silently spelled expressions,” 2024.258
[10] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,259
and P. Green, “Isolated word recognition of silent speech260
using magnetic implants and sensors,” 2010. [Online]. Available:261
https://pubmed.ncbi.nlm.nih.gov/20863739/262
[11] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-263
nectionist temporal classification,” 2006.264
[12] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and265
M. Stone, “Development of a silent speech interface driven by266
ultrasound and optical images of the tongue and lips,” 2010.267
[13] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,268
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-269
wards mobile, hands-free, silent speech text entry using elec-270
tropalatography,” 2022.271
[14] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-272
tion of electropalatographic data using latent variable models,”273
1998.274
[15] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction275
methods and their implications for studies of lingual coarticula-276
tion,” 1991.277
[16] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth mea-278
surement of face and palate by structured light,” 1993.279
[17] A. Toutios and K. Margaritis, “Learning electropalatograms from280
acoustics,” 2006.281
[18] ——, “On the acoustic-to-electropalatographic mapping,” 2006.282
[19] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph, E. D. Cubuk,283
and Q. V . Le, “Specaugment: A simple data augmentation method284
for automatic speech recognition,” 2019.285
