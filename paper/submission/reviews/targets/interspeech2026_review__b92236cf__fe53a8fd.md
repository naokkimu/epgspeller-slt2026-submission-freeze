...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "b92236cfe33de6fef90b48e22ad69a93614f5e4ca540c420d3e959eccfedc015",
    "sha8": "b92236cf",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "fe53a8fd049c6a97d6272e21ab4e269b0a0b3f958e64c1849e24549733a1a719",
    "sha8": "fe53a8fd"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_b92236cf_fe53a8fd"
}
```
...
We evaluate cross-participant transfer with the fourth par-157
ticipant as target under single-source and paired-source settings.158
Paired-source transfer is often lower error than single-159
source transfer, but direction-level outcomes are mixed.160
We compare vector, row/col, and grid-based front ends at161
full channels across protocols.162
Row/col tracks the vector baseline more closely than grid163
variants. Grid variants tend to worsen accuracy and increase164
latency, and patchpool reduces but does not remove this gap.165
We evaluate reduced-channel subsets using within-166
participant, transfer, and random selection strategies.167
Within-participant selection is similar to the vector base-168
line, while transfer and random subsets are generally lower and169
mixed across protocols.170
We evaluate paired-source cross-participant transfer under171
the same target and protocol constraints.172
Paired-source transfer is mixed across targets and front173
ends. 174
We evaluate low-shot adaptation by varying the number of175
training instances per word for a new participant.176
Two-shot generally improves over one-shot, while layout-177
aware variants remain mixed relative to the vector baseline.178
5. Discussion179
Across protocols, layout-aware front ends do not consistently180
outperform the vector baseline and often increase streaming181
cost; the patchpool grid reduces but does not eliminate the gap.182
Cross-participant transfer remains the main bottleneck. Source183
aggregation and low-shot adaptation help in some settings, but184
outcomes are mixed, and simple similarity indicators do not185
yield a single rule for when multi-source helps. Design implica-186
...
tion: when low latency is the priority, the vector or row/col front187
ends are safer choices; when robustness to electrode dropout188
or spatial priors is desired, grid-based options require careful189
tuning and validation. These takeaways depend on the audited190
datasets, split protocols, and evaluation pipeline, and they may191
not transfer to other sensors, labeling schemes, or participant192
populations.193
6. Artifacts and Auditability194
This repository uses a strict paper registry that pins every ev-195
idence file by checksum and rejects unsupported manuscript196
blocks. The split manifests, aggregated metrics, compact ta-197
bles, statistical summaries, and analysis reports referenced in198
this paper are stored as deterministic artifacts, enabling audit199
and reproduction within our repository environment. A supple-200
mentary archive includes the compact statistical summary table201
for reviewers.202
7. Ethics and Disclosure203
We report results only for audited artifacts and do not claim204
broader demographic coverage. The datasets and splits used in205
this study are derived from participant recordings, and we focus206
on methodological clarity and artifact traceability rather than207
deployment claims.208
8. Generative AI Use Disclosure209
We used generative AI tools for language polishing and format-210
ting support, and we verified technical claims against audited211
artifacts.212
...
9. References213
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and214
J. Brumberg, “Silent speech interfaces,” 2010.215
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction216
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and217
Computer Engineering. Springer, 2017.218
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,219
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces220
for speech restoration: A review,” 2020.221
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,222
“New developments in electropalatography: A state-of-the-art re-223
port,” 1989.224
[5] W. J. Hardcastle, “Electropalatography in phonetic research and225
in speech training,” 1990.226
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and227
S. Lee, “Biosignal sensors and deep learning-based speech recog-228
nition: A review,” 2021.229
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,230
“Visualisation and analysis of speech production with elec-231
tropalatography,” 2019.232
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and233
evaluation of korean electropalatography (k-epg),” 2021.234
[9] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-235
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-236
the-ear silently spelled expressions,” 2024.237
[10] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,238
and P. Green, “Isolated word recognition of silent speech239
using magnetic implants and sensors,” 2010. [Online]. Available:240
https://pubmed.ncbi.nlm.nih.gov/20863739/241
[11] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-242
nectionist temporal classification,” 2006.243
[12] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and244
M. Stone, “Development of a silent speech interface driven by245
ultrasound and optical images of the tongue and lips,” 2010.246
[13] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,247
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-248
wards mobile, hands-free, silent speech text entry using elec-249
tropalatography,” 2022.250
[14] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-251
tion of electropalatographic data using latent variable models,”252
1998.253
[15] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction254
methods and their implications for studies of lingual coarticula-255
tion,” 1991.256
[16] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth mea-257
surement of face and palate by structured light,” 1993.258
[17] A. Toutios and K. Margaritis, “Learning electropalatograms from259
acoustics,” 2006. 260
[18] ——, “On the acoustic-to-electropalatographic mapping,” 2006.261
[19] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph, E. D. Cubuk,262
and Q. V . Le, “Specaugment: A simple data augmentation method263
for automatic speech recognition,” 2019.264
