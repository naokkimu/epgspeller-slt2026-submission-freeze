...
```json
{
  ...
  "pdf": {
    ...
    "sha256": "2348c494c0270b694f716fb78b5b0d2d9cb82ff6bbffeb5f3bbe01305be30187",
    "sha8": "2348c494",
    "truncated": false
  },
  ...
  "tex": {
    ...
    "sha256": "53ab2654efb3d0f51a0db4b83bdd82b663c900b5ce9c8da03977bf98134a73a4",
    "sha8": "53ab2654"
  }
}
```
...
```json
{
  ...
  "run_id": "INTSP2026_STATIC_2348c494_53ab2654"
}
```
...
rize results over four split seeds as mean±std; confidence inter-126
vals are not reported in this manuscript.127
3. Models128
...
cols. All metrics are derived from the same audited registry.149
We evaluate cross-participant transfer with the fourth par-150
ticipant as target under single-source and paired-source settings.151
Paired-source transfer is often lower error than single-152
source transfer, but direction-level outcomes are mixed.153
We compare vector, row/col, and grid-based front ends at154
full channels across protocols.155
Row/col tracks the vector baseline more closely than grid156
variants. Grid variants tend to worsen accuracy and increase157
latency, and patchpool reduces but does not remove this gap.158
We evaluate reduced-channel subsets using within-159
participant, transfer, and random selection strategies.160
Within-participant selection is similar to the vector base-161
line, while transfer and random subsets are generally lower and162
mixed across protocols.163
We evaluate paired-source cross-participant transfer under164
the same target and protocol constraints.165
Paired-source transfer is mixed across targets and front166
ends. 167
We evaluate low-shot adaptation by varying the number of168
training instances per word for a new participant.169
Two-shot generally improves over one-shot, while layout-170
aware variants remain mixed relative to the vector baseline.171
5. Discussion172
Across protocols, layout-aware front ends do not consistently173
outperform the vector baseline and often increase streaming174
cost; the patchpool grid reduces but does not eliminate the gap.175
Cross-participant transfer remains the main bottleneck. Source176
aggregation and low-shot adaptation help in some settings, but177
outcomes are mixed, and simple similarity indicators do not178
yield a single rule for when multi-source helps. Design implica-179
tion: when low latency is the priority, the vector or row/col front180
ends are safer choices; when robustness to electrode dropout181
or spatial priors is desired, grid-based options require careful182
tuning and validation. These takeaways depend on the audited183
datasets, split protocols, and evaluation pipeline, and they may184
not transfer to other sensors, labeling schemes, or participant185
populations. 186
...
6. Artifacts and Auditability187
This repository uses a strict paper registry that pins every ev-188
idence file by checksum and rejects unsupported manuscript189
blocks. The split manifests, aggregated metrics, compact tables,190
and analysis summaries referenced in this paper are stored as191
deterministic artifacts, enabling audit and reproduction within192
our repository environment. The same artifacts are reused to193
build the manuscript tables and to support verification in the194
audit views.195
7. Ethics and Disclosure196
We report results only for audited artifacts and do not claim197
broader demographic coverage. The datasets and splits used in198
this study are derived from participant recordings, and we focus199
on methodological clarity and artifact traceability rather than200
deployment claims.201
8. Generative AI Use Disclosure202
We used generative AI tools for language polishing and format-203
ting support, and we verified technical claims against audited204
artifacts.205
9. References206
[1] B. Denby, T. Schultz, K. Honda, T. Hueber, J. Gilbert, and207
J. Brumberg, “Silent speech interfaces,” 2010.208
[2] J. Freitas, A. Teixeira, M. S. Dias, and S. Silva,An Introduction209
to Silent Speech Interfaces, ser. SpringerBriefs in Electrical and210
Computer Engineering. Springer, 2017.211
[3] J. A. Gonzalez-Lopez, A. Gomez-Alanis, J. M. Martin Donas,212
J. L. Perez-Cordoba, and A. M. Gomez, “Silent speech interfaces213
for speech restoration: A review,” 2020.214
[4] W. Hardcastle, W. Jones, C. Knight, A. Trudgeon, and G. Calder,215
...
“New developments in electropalatography: A state-of-the-art re-216
port,” 1989. 217
[5] W. J. Hardcastle, “Electropalatography in phonetic research and218
in speech training,” 1990.219
[6] W. Lee, J. J. Seong, B. Ozlu, B. S. Shim, A. Marakhimov, and220
S. Lee, “Biosignal sensors and deep learning-based speech recog-221
nition: A review,” 2021.222
[7] J. Verhoeven, N. R. Miller, L. Daems, and C. C. Reyes-Aldasoro,223
“Visualisation and analysis of speech production with elec-224
tropalatography,” 2019.225
[8] S.-T. Woo, J.-W. Ha, S. Na, H. Choi, and S.-B. Pyun, “Design and226
evaluation of korean electropalatography (k-epg),” 2021.227
[9] X. Dong, Y . Chen, Y . Nishiyama, K. Sezaki, Y . Wang, K. Christof-228
ferson, and A. Mariakakis, “Rehearsse: Recognizing hidden-in-229
the-ear silently spelled expressions,” 2024.230
[10] J. Gilbert, S. Rybchenko, R. Hofe, S. Ell, M. Fagan, R. Moore,231
and P. Green, “Isolated word recognition of silent speech232
using magnetic implants and sensors,” 2010. [Online]. Available:233
https://pubmed.ncbi.nlm.nih.gov/20863739/234
[11] A. Graves, S. Fern ´andez, F. Gomez, and J. Schmidhuber, “Con-235
nectionist temporal classification,” 2006.236
...
[12] T. Hueber, E.-L. Benaroya, G. Chollet, B. Denby, G. Dreyfus, and237
M. Stone, “Development of a silent speech interface driven by238
ultrasound and optical images of the tongue and lips,” 2010.239
[13] N. Kimura, T. Gemicioglu, J. Womack, R. Li, Y . Zhao, A. Bedri,240
Z. Su, A. Olwal, J. Rekimoto, and T. Starner, “Silentspeller: To-241
wards mobile, hands-free, silent speech text entry using elec-242
tropalatography,” 2022.243
[14] M. ´A. Carreira-Perpi ˜n´an and S. Renals, “Dimensionality reduc-244
tion of electropalatographic data using latent variable models,”245
1998.246
[15] W. Hardcastle, F. Gibbon, and K. Nicolaidis, “Epg data reduction247
methods and their implications for studies of lingual coarticula-248
tion,” 1991.249
[16] C. H. Shadle, J. N. Carter, T. P. Monks, and J. Field, “Depth mea-250
surement of face and palate by structured light,” 1993.251
[17] A. Toutios and K. Margaritis, “Learning electropalatograms from252
acoustics,” 2006.253
[18] ——, “On the acoustic-to-electropalatographic mapping,” 2006.254
[19] D. S. Park, W. Chan, Y . Zhang, C.-C. Chiu, B. Zoph, E. D. Cubuk,255
and Q. V . Le, “Specaugment: A simple data augmentation method256
for automatic speech recognition,” 2019.257
