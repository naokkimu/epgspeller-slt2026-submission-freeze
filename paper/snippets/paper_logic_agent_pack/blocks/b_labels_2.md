...
### st_b_labels_2_01
We keep the label normalization step consistent across all splits and dataset preparation steps.
...
### st_b_labels_2_02
This aligns the decoder vocabulary with the audited labels and reduces drift between training and artifacts used to evaluate.
