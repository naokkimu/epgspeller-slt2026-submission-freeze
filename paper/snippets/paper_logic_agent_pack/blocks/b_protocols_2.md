...
### st_b_protocols_2_01
All split archives are generated deterministically from audited exports with fixed seeds.
...
### st_b_protocols_2_02
Each train, test, and competition partition is stored as an immutable archive with a checksum in the manifests to enable reuse and later verification.
...
### st_b_protocols_2_03
The manifests show the word-holdout protocol uses all four participant datasets.
...
### st_b_protocols_2_04
They show the instance-holdout protocol uses three participant datasets.
...
### st_b_protocols_2_05
They also show the fourth participant appears only as a target in the cross-participant splits.
...
### st_b_protocols_2_06
This separation explains why the dataset summary includes all participant datasets even when a protocol uses only a subset.
